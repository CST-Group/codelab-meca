 ...
 */
public class ChangeTrafficLightPhase extends MotivationalBehavioralCodelet {
	...
	public ChangeTrafficLightPhase(String id, String motorCodeletId, ArrayList<String> motivationalCodeletsIds, String soarCodeletId){
